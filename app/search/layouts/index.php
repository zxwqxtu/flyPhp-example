...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>搜索</title>
        <link rel="stylesheet" type="text/css" href="<?php echo $this->getConfig('cssHost');?>/baidu.css"></link>
        ...
        <script type='text/javascript' src="<?php echo $this->getConfig('jsHost');?>/baidu-header.js"></script>
    </head>
    <body>
